...
class MainForm(Form):
    ...
    def InitializeComponent(self):
        ...
        resources = System.Resources.ResourceManager("LETS_GO_GAMBLING.MainForm", System.Reflection.Assembly.GetEntryAssembly())
    ...
    def Timer1Tick(self, sender, e):
        ...
        pb5 = self._pictureBox5
        images = [im1, im2, im3, im4, im5]
        
        for lcd in range (0, 1000):
            num1 = rnd.Next(1,6)
            num2 = rnd.Next(1,6)
            num3 = rnd.Next(1,6)
            num4 = rnd.Next(1,6)
